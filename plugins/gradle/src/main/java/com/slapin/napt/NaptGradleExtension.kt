...
open class NaptGradleExtension(objectFactory: ObjectFactory) {
    ...
    /**
     * By default, plugin will generate NaptTrigger.java only for the main source set, but there
     * might be cases when you need annotation processing for different source sets (e.g. test)
     *
